...
public class J07075_LichGiangDayTheoGiangVien {
    ...
    static class LichHoc{
        ...
        private String monDangKy;

        public void setMonDangKy(String monDangKy) {
        ...
        public String toString() {
            return maNhom + " " + monDangKy + " " + ngayGiang + " " + kipHoc + " " + phongHoc;
        }
    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for(monHoc it : arr1){
            for(LichHoc it1 : arr2){
                if(it1.getMaMon().equals(it.getMaMonHoc())){
                    it1.setMonDangKy(it.getTenMonHoc());
                }
            }
        }
        
        String check = sc2.nextLine();
        System.out.println("LICH GIANG DAY GIANG VIEN " + check + ":");
        
        for(LichHoc it : arr2){
            if(check.equals(it.getTenGV())){
